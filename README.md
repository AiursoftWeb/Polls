...
[![MIT licensed](https://img.shields.io/badge/license-MIT-blue.svg)](https://gitlab.aiursoft.com/aiursoft/polls/-/blob/master/LICENSE)
...
[![Test Coverage](https://gitlab.aiursoft.com/aiursoft/polls/badges/master/coverage.svg)](https://gitlab.aiursoft.com/aiursoft/polls/-/pipelines)
[![Man hours](https://manhours.aiursoft.com/r/gitlab.aiursoft.com/aiursoft/polls.svg)](https://manhours.aiursoft.com/r/gitlab.aiursoft.com/aiursoft/polls.html)
...
Try a running Polls [here](https://polls.aiursoft.com).
...
```bash
curl -sL https://gitlab.aiursoft.com/aiursoft/polls/-/raw/master/install.sh | sudo bash
```

Of course it is suggested that append a custom port number to the command:

```bash
curl -sL https://gitlab.aiursoft.com/aiursoft/polls/-/raw/master/install.sh | sudo bash -s 8080
```
