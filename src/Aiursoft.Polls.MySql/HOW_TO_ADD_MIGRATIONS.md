...
```bash
dotnet ef migrations remove --context "MySqlContext" -s ../Aiursoft.Polls/Aiursoft.Polls.csproj
```

## After Creating Migrations

After creating migrations for MySQL, remember to:
1. Create the corresponding migration for SQLite (see `../Aiursoft.Polls.Sqlite/HOW_TO_ADD_MIGRATIONS.md`)
